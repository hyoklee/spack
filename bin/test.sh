...
# Change install path.
setenv HDF5_PLUGIN_PATH /scr/hyoklee/src/spack-hyoklee/opt/spack/linux-centos7-haswell/gcc-4.8.5/hdf5-cmake-develop-7trbcmpjnklt72hoqxzswf7r3tezj7sz/lib/plugin/
