...
class SzCmake(CMakePackage):
    ...
    variant('hdf5-cmake', default=False, description="build the hdf5 filter")
    ...
    depends_on('hdf5-cmake', when="+hdf5-cmake")
